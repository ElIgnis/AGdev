#include "SceneManager_HighScore.h"

SceneManager_HighScore::SceneManager_HighScore()
{
}
...
void SceneManager_HighScore::Init(const int width, const int height, ResourcePool *RM, InputManager* controls)
{
...
void SceneManager_HighScore::Exit()
{
	SceneManagerSelection::Exit();
}

void SceneManager_HighScore::BindShaders()
{
	SceneManagerSelection::BindShaders();
}

// Other specific init, update and render classes
void SceneManager_HighScore::InitShader()
{
...
void SceneManager_HighScore::RenderBG()
{
	Mesh* drawMesh;
	drawMesh = resourceManager.retrieveMesh("Background");
	drawMesh->textureID = resourceManager.retrieveTexture("HIGHSCORE_BG");
...
void SceneManager_HighScore::RenderMobileObject()
{
}

void SceneManager_HighScore::RenderSelection()
{
...
void SceneManager_HighScore::UpdateMouse()
{
	SceneManagerSelection::UpateMouse();
}

void SceneManager_HighScore::UpdateSelection()
{
