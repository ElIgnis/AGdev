#include "SceneManager_Pause.h"

SceneManager_Pause::SceneManager_Pause()
{
}
...
void SceneManager_Pause::Init(const int width, const int height, ResourcePool *RM, InputManager* controls)
{
...
void SceneManager_Pause::Render()
{
...
void SceneManager_Pause::RenderMobileObject()
{
}

void SceneManager_Pause::RenderSelection()
{
...
void SceneManager_Pause::UpdateMouse()
{
	SceneManagerSelection::UpateMouse();
}

void SceneManager_Pause::UpdateSelection()
{
