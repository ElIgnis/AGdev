#include "SceneManager_Play.h"

SceneManager_Play::SceneManager_Play() :
...
void SceneManager_Play::Config()
{
	SceneManagerGameplay::Config("Config\\GameStateConfig\\PlayConfig.txt");
}

void SceneManager_Play::Config(string directory)
{
...
void SceneManager_Play::RenderBG()
{
...
void SceneManager_Play::FSMApplication()
{
	Vector3 newPosition;
...
SceneNode* SceneManager_Play::getNode()
{
	for (unsigned i = 0; i < nodeList.size(); ++i)
	{
