...
void SceneManager_Play_L1::Config(string directory)
{
...
void SceneManager_Play_L1::Update(double dt)
{
...
void SceneManager_Play_L1::UpdateSP(double dt)
{
...
void SceneManager_Play_L1::UpdatePlayer(double dt)
{
	//Updates the weapon	
...
void SceneManager_Play_L1::UpdateEnemy(double dt)
{
	spawnTimer += dt;
...
bool SceneManager_Play_L1::CheckSelfCollide(SceneNode* first, SceneNode* second)
{
...
void SceneManager_Play_L1::CollisionResponse(SceneNode* first, SceneNode* second, double dt)
{
...
//
//bool SceneManager_Play_L1::ProcessCollision(SceneNode* first, SceneNode* second)
//{
//	string boxName = "";
//	if (first->GetGameObject()->getName() == "Head"
//		|| first->GetGameObject()->getName() == "Player"
...
void SceneManager_Play_L1::Render()
{
...
void SceneManager_Play_L1::Exit()
{
...
void SceneManager_Play_L1::RenderLight(const float rotation, const float x, const float y, const float z)
{
	//Lights
...
void SceneManager_Play_L1::RenderBG()
{

}

void SceneManager_Play_L1::RenderStaticObject()
{
...
void SceneManager_Play_L1::RenderMobileObject()
{
	static Mesh* debugMesh = resourceManager.retrieveMesh("DEBUG_CUBE");
...
void SceneManager_Play_L1::InitSceneGraph()
{
	// root node
